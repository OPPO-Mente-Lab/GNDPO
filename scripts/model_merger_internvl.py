...
if __name__ == "__main__":
    ...
    parser.add_argument("--local_dir", type=str, help="The path for your saved model", default="/mnt/data/group/lizhihao/EasyR1/checkpoints/easy_r1/andesvl_采集数据_grpo_07311935/global_step_5/actor")
    ...
    # 保存为 pytorch_model.bin形式
    # torch.save(state_dict, os.path.join(local_dir, "pytorch_model.bin"))
    ...
    if "ForTokenClassification" in architectures[0]:
    ...
    elif "InternVLChatModel" in architectures[0]:
        AutoClass = AutoModelForCausalLM
        import shutil
        ...
        src_dir = "/mnt/data/group/models/InternVL3_5-4B"
