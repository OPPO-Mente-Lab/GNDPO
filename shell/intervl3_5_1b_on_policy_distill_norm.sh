...
# Set the task name
CURRENT_PATH=$(pwd)
PROJECT_NAME=internvl3_5_1b
TASK_NAME=internvl3_5_1b_on_policy_distill_norm_bs32_minibs32_n16_geo3k
TASK_NAME="${TASK_NAME%.*}"
...
python3 -m verl.trainer.main_ppo \
    algorithm.adv_estimator=on_policy_distill_norm \
    ...
    actor_rollout_ref.model.path=OpenGVLab/InternVL3_5-1B-Instruct \
